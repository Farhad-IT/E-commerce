...
from app.cart.cart_item_schemas import CartItemSchema, CartItemUpdateSchema, CartItemCreateSchema
...
async def get_by_product_id(
    ...
    return await cart_service.get_by_product_id(user_id=current_user.id, product_id=product_id)
...
async def add_item_to_cart(
    ...
    return await cart_service.add_item_to_cart(user_id=current_user.id, create_item=create_item)
...
async def update_by_product_id(
    ...
    return await cart_service.update_quantity(user_id=current_user.id, product_id=product_id, update_item=update_item)
